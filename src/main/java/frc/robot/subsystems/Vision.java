...
public final class Vision extends SubsystemBase implements NiceSubsystem {
    ...
    private final HashMap<String, VisionCamera> cameraMap;
    ...
    private Vision() {
        ...
        cameras = new VisionCamera[4];

        cameras[0] = new VisionCamera(frontLeftPhotonCamera, frontLeftCameraPosition);
        cameras[1] = new VisionCamera(frontRightPhotonCamera, frontRightCameraPosition);
        cameras[2] = new VisionCamera(backLeftPhotonCamera, backLeftCameraPosition);
        cameras[3] = new VisionCamera(backRightPhotonCamera, backRightCameraPosition);
    ...
    public VisionCamera getCamera(String cameraName) {
    ...
    public record VisionCamera(PhotonCamera camera, Transform3d cameraPosition) {
